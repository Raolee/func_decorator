...
type IsolationFuncType func(ctx context.Context, args ...any)
...
type Function[T any] struct {
	...
	composableBeforeFuncs []T
	isolatedAfterFuncs    []IsolationFuncType
	composableAfterFuncs  []T
}
...
func executeFuncUsingReflect[T any](fn T, args ...any) (results []any, err error) {
	defer func(e *error) {
		if r := recover(); r != nil {
